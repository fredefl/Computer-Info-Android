...
public class ComputerDetailFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_computer_detail, container, false);
		if (mItem != null) {
			try {
				((TextView) rootView.findViewById(R.id.computer_detail)).setText(mItem.computer.getString("serial"));
